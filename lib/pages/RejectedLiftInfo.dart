...
class RejectedLiftInfo extends StatefulWidget {
  final String notificationId;
  final String userId;
  //final String type;
  //final String driverOrPassengerName;

  RejectedLiftInfo({@required this.notificationId, @required this.userId});
  @override
  _RejectedLiftInfoState createState() => _RejectedLiftInfoState();
}

class _RejectedLiftInfoState extends State<RejectedLiftInfo> {
        ...
        builder: (context, snapshot) {
          if(snapshot.hasData) {
                          ...
                          child: ListView(
                              ...
                              children: [SizedBox(height: defaultSpace),
                                ...
                                Row(crossAxisAlignment: CrossAxisAlignment
                                    .start,
                                    children: [
                                      labelText(text: "Start City: "),
                                      Expanded(child: infoText(
                                          notification["startCity"]))
                                    ]),
                                SizedBox(height: defaultSpace),
                                Row(crossAxisAlignment: CrossAxisAlignment
                                    .start,
                                    children: [
                                      labelText(text: "Destination City: "),
                                      Expanded(child: infoText(
                                          notification["destCity"]))
                                    ]),
                                // SizedBox(height: defaultSpace),
                                // Row(crossAxisAlignment: CrossAxisAlignment
                                //     .start,
              ...
              return Scaffold(
                ...
                body: Container(
                    ...
                    child: Center(child: Text(
                      "Rejected lift notification deleted",
                    ),)),
                backgroundColor: mainColor,
              );
            }
            ...
            return Column(
                ...
                children: [
                  Icon(Icons.error),
                  Text("Error loading rejected lift info")
                ]);
          }else{
            return Scaffold(
              appBar: AppBar(
